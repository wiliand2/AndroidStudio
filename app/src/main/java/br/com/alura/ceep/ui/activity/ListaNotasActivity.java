...
import br.com.alura.ceep.dao.NotaDAO2;
...
public class ListaNotasActivity extends AppCompatActivity {
    ...
    public static final String TITULO_APPBAR = "Robson";
    ...
    private List<Nota> pegaTodasNotas() {
        NotaDAO2 dao = new NotaDAO2(this);/*TENTANDO ALTERAR AQI ------------*/
        return dao.todos();
    }
    ...
    private void altera(Nota nota, int posicao) {
        new NotaDAO2(ListaNotasActivity.this).altera(posicao, nota);
    ...
    private void adiciona(Nota nota) {
        new NotaDAO2(ListaNotasActivity.this).insere(nota);/*E AQUI TBM ------------------------*/
